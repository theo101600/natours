...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoidGhlbzEwMTYwMCIsImEiOiJjbWh0dzFtMXIwZXI5MmxzZGNkdTJkc3BuIn0.6YhUTyTt7RABYmbQUg65KQ";
  var map = new mapboxgl.Map({
    container: "map",
    // container ID
    style: "mapbox://styles/theo101600/cmhtx8xat00bj01subv019iyo",
    // style URL
    scrollZoom: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.dat, ": ").concat(loc.description, "</p>")).addTo(map);
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          stripe = Stripe("pk_test_51SVBVYBSWc98WbqkdeQiAMauZh1XVuoefgVYsv2XvJoAfguM0DSSLiErDrd6T0YqiDeoEqNcK9JxeWM98RoFkpsv00zD3Jngsx");
          _context.p = 1;
          _context.n = 2;
